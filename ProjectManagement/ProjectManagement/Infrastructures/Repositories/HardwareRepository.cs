...
namespace ProjectManagement.Infrastructures.Repositories
{
    public class HardwareRepository : IHardwareRepository
    {
        ...
        #region AftersalesPmHwIssueVerification
        ...
        public string AftersalesPmHwIssueDeclined(long ids, string DeclineReason)
        {
            ...
            if (ids > 0)
            {
                ...
                //var wpmsUsers3 = _dbeEntities.CmnUsers.FirstOrDefault(i => i.RoleName == "ASPMHEAD" && i.RoleName=="ASPM" && i.IsActive == true);
                ...
                body += "This is to inform you that R&D has declined this issue"
                ...
                body += "<br/><br/> <b>Model Name :</b>" + query.ModelName + "<br/><b>Module :</b>" + query.Module + "<br/><b>Issue Details :</b>" + query.IssueDetails +
                    ...
                    "<br/><b>Status :</b>" + query.Status + "<br/><b>Declined Reason :</b>" + query.DeclineReason + "<br/><br/><br/>";

                var mailSendFromPms = new MailSendFromPms();
                mailSendFromPms.SendMail(ids3, ids4, "Issue has been declined by R&D.", body);
        ...
        public string SaveAftersalesPmHwIssuePlaceRequirement(long ids, string placeRequirement)
        {
            String userIdentity = System.Web.HttpContext.Current.User.Identity.Name;
            long userId = Convert.ToInt64(userIdentity == "" ? "0" : userIdentity);

            var model = new AftersalesPm_HwIssuePlaceRequirement();
            model.MainId = ids;
            model.RequirementDetails = placeRequirement;
            model.ReqStatus = "RequirementPlaced";
            model.Added = userId;
            model.AddedDate = DateTime.Now;
            _dbeEntities.AftersalesPm_HwIssuePlaceRequirement.Add(model);
            _dbeEntities.SaveChanges();
            ...
            query.Status = "RequirementPlaced";
            query.Updated = userId;
            query.UpdatedDate = DateTime.Now;
            _dbeEntities.AftersalesPm_HwIssueVerification.AddOrUpdate(query);
            _dbeEntities.SaveChanges();
            ...
            if (ids > 0)
            {
                ...
                body += "This is to inform you that requirement has been placed by  <b>" + wpmsUsers.UserFullName
                    + "</b>. Please report within 14 days. Issue details are given below : ";

                body += "<br/><br/> <b>Model Name :</b>" + query.ModelName + "<br/><b>Module :</b>" + query.Module + "<br/><b>Issue Details :</b>" + query.IssueDetails +
                     "<br/><b>Issue Type :</b>" + query.IssueType + "<br/><b>Result :</b>" + query.ResultFound + "<br/><b>Remarks :</b>" + query.Remarks +
                    "<br/><b>Status :</b>" + query.Status + "<br/><b>Requirement Details :</b>" + model.RequirementDetails + "<br/><br/><br/>";

                var mailSendFromPms = new MailSendFromPms();
                mailSendFromPms.SendMail(ids3, ids4, "Requirement placed by R&D.", body);
        ...
        public AftersalesPm_HwIssuePlaceRequirementModel CheckExistingDate(long id)
        {
            var query = _dbeEntities.Database.SqlQuery<AftersalesPm_HwIssuePlaceRequirementModel>(@"
                 select Status  as ReqStatus FROM [CellPhoneProject].[dbo].[AftersalesPm_HwIssueVerification] where Id={0} ", id).FirstOrDefault();

            return query;
        }
        public List<AftersalesPm_HwIssuePlaceRequirementModel> GetRequirementDetailsForPerModel(long id)
        {
            var query = _dbeEntities.Database.SqlQuery<AftersalesPm_HwIssuePlaceRequirementModel>(@"SELECT * 
             FROM [CellPhoneProject].[dbo].[AftersalesPm_HwIssuePlaceRequirement] afi  where  MainId={0} order by Id desc", id).ToList();

            return query;
        }

        public List<AftersalesPm_HwIssueReportShareModel> GetReportShareDetailsForPerModel(long id)
        {
            var query = _dbeEntities.Database.SqlQuery<AftersalesPm_HwIssueReportShareModel>(@"SELECT * 
             FROM [CellPhoneProject].[dbo].[AftersalesPm_HwIssueReportShare] afi  where  MainId={0} order by Id desc", id).ToList();

            return query;
        }

        public string SaveAftersalesPmHwIssueReportShare(long ids, string reportDetails, string instructionService,
            string instructionProduction, string futurePlanForNxtPro)
        {
            String userIdentity = System.Web.HttpContext.Current.User.Identity.Name;
            long userId = Convert.ToInt64(userIdentity == "" ? "0" : userIdentity);

            var model = new AftersalesPm_HwIssueReportShare();
            model.MainId = ids;
            model.ReportDetails = reportDetails;
            model.InstructionService = instructionService;
            model.InstructionProduction = instructionProduction;
            model.FuturePlanForNxtPro = futurePlanForNxtPro;
            model.Status = "ReportShared";
            model.Added = userId;
            model.AddedDate = DateTime.Now;
            _dbeEntities.AftersalesPm_HwIssueReportShare.Add(model);
            _dbeEntities.SaveChanges();
            ...
            if (ids > 0)
            {
                ...
                body += "This is to inform you that report has been shared by  <b>" + wpmsUsers.UserFullName
                    + "</b>. Please close the market issue within 14 days. Issue details are given below : ";

                body += "<br/><br/> <b>Model Name :</b>" + query.ModelName + "<br/><b>Module :</b>" + query.Module + "<br/><b>Issue Details :</b>" + query.IssueDetails +
                     "<br/><b>Issue Type :</b>" + query.IssueType + "<br/><b>Result :</b>" + query.ResultFound + "<br/><b>Remarks :</b>" + query.Remarks +
                    "<br/><b>Status :</b>" + query.Status + "<br/><b>Details of Report :</b>" + model.ReportDetails + "<br/><b>Instruction Service :</b>" + model.InstructionService + "<br/><b>Instruction Production :</b>" + model.InstructionProduction + "<br/><b>Future Plan For Next Products :</b>" + model.FuturePlanForNxtPro + "<br/><br/><br/>";

                var mailSendFromPms = new MailSendFromPms();
                mailSendFromPms.SendMail(ids3, ids4, "Report shared by R&D.", body);
