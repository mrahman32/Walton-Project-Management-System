...
namespace ProjectManagement.Infrastructures.Interfaces
{
    interface IHardwareRepository
    {
        ...
        string AftersalesPmHwIssueDeclined(long ids, string DeclineReason);
        string SaveAftersalesPmHwIssuePlaceRequirement(long ids, string placeRequirement);
        AftersalesPm_HwIssuePlaceRequirementModel CheckExistingDate(long id);
        List<AftersalesPm_HwIssuePlaceRequirementModel> GetRequirementDetailsForPerModel(long id);
        List<AftersalesPm_HwIssueReportShareModel> GetReportShareDetailsForPerModel(long id);
        string SaveAftersalesPmHwIssueReportShare(long ids, string reportDetails, string instructionService, string instructionProduction, string futurePlanForNxtPro);
       #endregion
