...
namespace ProjectManagement.Infrastructures.Interfaces
{
    public interface ICommonRepository
    {
        ...
        List<ProjectMasterModel> GetProjectMasterModels();
        ...
        void SaveLcOpeningApprovalDetail(LcOpeningApprovalDetail mod);
        void SaveLcOpeningApprovalOtherProductDetail(LcOpeningApprovalOtherProductDetail mod);
        ...
        List<LcOpeningPermissionModel> RelevantModelPickPendingProjectsForLc();
        ...
        List<MaterialWastageMasterModel> GetPendingApprovals(int approvalStage, string identityName);
        EditMaterialWastageViewModel GetMaterialWastageById(long id);
        ...
        List<string> RoleDescriptionList();
        void SaveLcApprovalManager(LcApprovalManagerModel model);
        List<LcApprovalManagerModel> GetLcApprovalManagerModels();
        List<string> GetRoleByDescription(string desc);
        string GetDescriptionByRole(string role);
        LcApprovalManagerModel GetLcApprovalManagerByRole(string role);
        bool CheckInitiationApprovalByRoleDesc(string roleDesc, long permId);
        List<LcOpeningPermissionModel> GetOpeningPermissionByRoleDesc(string roleDesc);
        List<LcOpeningPermissionOtherProductModel> GetOtherProdPermByRoleDesc(string roleDesc);
        string GetInitiationApprovedNameByLcId(long lcId);

        #endregion

        List<ProjectImageModel> GetProjectImages();
